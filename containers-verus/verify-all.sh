...
for mod in tagged index_like dense_id diff_store capture_bits parallel_store inline_store frame container_id fork_history vec append_only_vec map sparse_set; do
  printf "%-20s " "$mod:"
