...
for mod in tagged index_like dense_id diff_store capture_bits parallel_store inline_store frame opt container_id fork_history vec append_only_vec map sparse_set list circular_list bplus bplus_layout bplus_search; do
  printf "%-20s " "$mod:"
