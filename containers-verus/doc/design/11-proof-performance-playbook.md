...
[Proof Attempts Log](08-proof-attempts-log.md) (the chronological narrative) and
the [Trust Boundary](10-trust-boundary.md) (what is `external_body` and why).
...
see [Trust Boundary §3](10-trust-boundary.md).
...
- **Measure blast radius before committing to an approach.** For a risky spec
  ...
  to scope the M6 `wf`-clause addition before threading it through the recursion.
