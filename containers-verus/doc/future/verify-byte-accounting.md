...
reference, [Design Ch. 10](../design/10-trust-boundary.md).*
...
[Ch. 10 §2](../design/10-trust-boundary.md) for the full account):
...
[Ch. 10 §1](../design/10-trust-boundary.md).
...
- This does **not** touch Group A (`ContainerId`). That stays `external_body` by
  design; see [Ch. 10 §1](../design/10-trust-boundary.md). Distinctness is left
  fuzz-checked, not proved, for the reasons recorded there and in
  [Ch. 2 §4c](../design/02-fork-history.md).
