...
Historical loaded-host r6 medians
(`records/campaigns/final-r6-tables.md`) were egglog 23.2 ms; ours rules
99.1 ms naive and 92.9 ms semi-naive. They have no bootstrap confidence
intervals and do not measure the current implementation. Attribution from the
original diagnosis: deleting the
