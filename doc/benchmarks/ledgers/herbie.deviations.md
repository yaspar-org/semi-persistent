...
of our saturation strategies. Historical loaded-host r6 medians
(`records/campaigns/final-r6-tables.md`) were egglog 96.9 ms; ours rules
32.3 ms naive and 31.4 ms semi-naive; ours native 15.8 ms naive and 20.1 ms
semi-naive. Those process medians have no bootstrap confidence intervals and
do not measure the current implementation.
