...
//! The MCTS-solver closed bit (plan item A8, doc/au-solver-plan.md).
//!
//! B1 measured that MCGS certifies wide, shallow search graphs within a factor
...
//! are already fully realized (comparison/au/anytime-corpus.md). The closed bit
...
/// `sum A(v)`, the certification budget B1 predicts, computed without running
/// either solver.
