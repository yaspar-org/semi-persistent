...
//! `EGRAPH_SEEK=1` prints both tables at exit. The alias establishes the source
//! shape when disabled; any claim about generated code or runtime overhead
//! still requires a same-revision Criterion comparison.
//!
...
/// bucket. 2^20 is past the longest bucket any program under `doc/benchmarks/`
