...
//!
//! This is the hand-written production aggregate from immediately before the
//! e-graph moved to `containers-verus`. Its ring remains deliberately
//! independent of the verified `CircularList`, making this implementation
//! useful as a differential oracle.

use crate as containers;
use crate::list::{ListArena, ListArenaToken};
use crate::sparse_set::{SparseSet, SparseSetToken};
use crate::union_find::{ProofBuf, UnionFind, UnionFindToken};
